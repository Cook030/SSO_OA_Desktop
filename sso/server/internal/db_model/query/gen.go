...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		db:                 db,
		SysAuditLog:        newSysAuditLog(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		db:                 db,
		SysAuditLog:        q.SysAuditLog.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		db:                 db,
		SysAuditLog:        q.SysAuditLog.replaceDB(db),
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		SysAuditLog:        q.SysAuditLog.WithContext(ctx),
