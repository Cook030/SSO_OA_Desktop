...
func newSysUserRole(db *gorm.DB, opts ...gen.DOOption) sysUserRole {
	...
	_sysUserRole.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_sysUserRole.RequestID = field.NewString(tableName, "request_id")
...
type sysUserRole struct {
	...
	ALL        field.Asterisk
	ID         field.Int64
	UserID     field.Int64  // 用户ID(sys_user.id)
...
func (s sysUserRoleDo) Create(values ...*db_model.SysUserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysUserRoleDo) CreateInBatches(values []*db_model.SysUserRole, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysUserRoleDo) Save(values ...*db_model.SysUserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysUserRoleDo) First() (*db_model.SysUserRole, error) {
...
func (s sysUserRoleDo) Take() (*db_model.SysUserRole, error) {
...
func (s sysUserRoleDo) Last() (*db_model.SysUserRole, error) {
...
func (s sysUserRoleDo) Find() ([]*db_model.SysUserRole, error) {
	result, err := s.DO.Find()
	return result.([]*db_model.SysUserRole), err
}

func (s sysUserRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_model.SysUserRole, err error) {
...
func (s sysUserRoleDo) FindInBatches(result *[]*db_model.SysUserRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysUserRoleDo) FirstOrInit() (*db_model.SysUserRole, error) {
...
func (s sysUserRoleDo) FirstOrCreate() (*db_model.SysUserRole, error) {
...
func (s sysUserRoleDo) FindByPage(offset int, limit int) (result []*db_model.SysUserRole, count int64, err error) {
...
func (s sysUserRoleDo) Delete(models ...*db_model.SysUserRole) (result gen.ResultInfo, err error) {
