...
func (s sysUserDo) Create(values ...*db_model.SysUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysUserDo) CreateInBatches(values []*db_model.SysUser, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysUserDo) Save(values ...*db_model.SysUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysUserDo) First() (*db_model.SysUser, error) {
...
func (s sysUserDo) Take() (*db_model.SysUser, error) {
...
func (s sysUserDo) Last() (*db_model.SysUser, error) {
...
func (s sysUserDo) Find() ([]*db_model.SysUser, error) {
	result, err := s.DO.Find()
	return result.([]*db_model.SysUser), err
}

func (s sysUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_model.SysUser, err error) {
...
func (s sysUserDo) FindInBatches(result *[]*db_model.SysUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysUserDo) FirstOrInit() (*db_model.SysUser, error) {
...
func (s sysUserDo) FirstOrCreate() (*db_model.SysUser, error) {
...
func (s sysUserDo) FindByPage(offset int, limit int) (result []*db_model.SysUser, count int64, err error) {
...
func (s sysUserDo) Delete(models ...*db_model.SysUser) (result gen.ResultInfo, err error) {
